...
export default class CustomerApi {
    static create(params: ICustomer): Promise<AxiosResponse> {
    ...
    static findOne(id: number): Promise<{ data: ICustomer }> {
    ...
    static update(borrowerId: number,params: ICustomer): Promise<number> {
